...
sleep 5
# Secrets-block
SECRET_VALUE=$(aws secretsmanager get-secret-value --secret-id arn:aws:secretsmanager:ap-southeast-1:886436967137:secret:weather-secret-kK8VyN --region ap-southeast-1 | jq -r .SecretString)
