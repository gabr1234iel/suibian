    ...
    >
      ...
      >
        ...
        <div className="relative z-10 pt-14">
          ...
          >
            <div className={`w-20 h-20 bg-gradient-to-br ${gradient} rounded-2xl flex items-center justify-center shadow-xl border border-white/30`}>
...
const FeatureCards: React.FC = () => {
  ...
  const cards = [
    {
      ...
      description: "Advanced machine learning algorithms analyze market patterns, predict price movements, and execute trades with superhuman precision and speed.",
    ...
    },
    {
      ...
      description: "Built on Sui blockchain for millisecond transactions. Our infrastructure ensures perfect timing for maximum profits and minimal slippage.",
    ...
    },
    {
      ...
      description: "Military-grade encryption, multi-signature wallets, and decentralized architecture protect your assets with rigorous security audits.",
    ...
    },
    {
      ...
      description: "Sophisticated algorithms identify profitable opportunities across multiple markets with automated portfolio rebalancing and risk management.",
  ...
  const handleWheel = useCallback((e: WheelEvent) => {
    ...
    if (Math.abs(newAccumulator) >= scrollThreshold) {
      if (newAccumulator > 0 && currentCardIndex < cards.length - 1) {
        ...
        setCurrentCardIndex(prev => prev - 1);
        setScrollAccumulator(0);
      } else if (newAccumulator > 0 && currentCardIndex === cards.length - 1) {
  ...
  return (
    <div className="relative">
      <section ref={containerRef} className="relative bg-gradient-to-br from-gray-900 via-black to-gray-900 min-h-screen pt-16">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 min-h-screen">
            ...
            <div className="relative flex items-center">
              <div className="sticky top-24 w-full py-20 px-6 lg:px-12">
                ...
                >
                  <p>
                    We are more than just another trading platform. SuiBian represents a paradigm shift in decentralized finance, combining cutting-edge AI technology with the security and speed of the Sui blockchain.
                  </p>
                  
                  <p>
                    When you join our ecosystem, you're not simply accessing trading tools, but acquiring a sophisticated AI partner that evolves with market conditions. Each agent is equipped with <strong className="text-white">advanced intelligence written into its core algorithms</strong>.
                  </p>
                  
                  <p>
                    This is not merely a trading platform but a revolutionary approach to autonomous financial management. A gateway to the future of decentralized trading.
                  </p>
                </motion.div>
