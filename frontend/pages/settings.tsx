  ...
  const faqItems = [
    {
      ...
      content: "A trading agent is an automated strategy created by experienced traders that can execute trades on your behalf based on predefined algorithms and market conditions."
    },
    {
      title: "How do fees work?",
      content: "Each trading agent charges a management fee (typically 1-5%) which is deducted from your profits. You only pay fees when the agent generates positive returns for you."
    },
    {
      title: "Is my money safe?",
      content: "All funds are secured through smart contracts on the blockchain. Agent creators cannot directly access your funds - they can only execute trades according to their published strategies."
    },
    {
      title: "Can I withdraw my money anytime?",
      content: "Yes, you can unsubscribe from any agent and withdraw your funds at any time. However, some strategies may have lock-up periods for optimal performance."
    },
    {
      title: "How are performance metrics calculated?",
      content: "All performance metrics are calculated in real-time based on actual trading results. Total return shows the cumulative performance, while win rate shows the percentage of profitable trades."
    },
    {
      title: "What happens if an agent performs poorly?",
      content: "You can unsubscribe from any underperforming agent at any time. We also provide risk management tools and recommendations to help you diversify your portfolio."
    },
    {
      title: "How do I create my own trading agent?",
      content: "To create an agent, you need to define your trading strategy, provide historical performance data, and pass our verification process. Visit the 'Create Agent' page to get started."
    },
    {
      title: "What are the risks involved?",
      content: "Trading cryptocurrencies involves significant risk and you may lose some or all of your investment. Different agents have different risk levels clearly marked to help you make informed decisions."
    }
  ];
