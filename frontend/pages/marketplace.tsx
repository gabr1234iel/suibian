          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            <div className="md:col-span-2">
              ...
              <input
                ...
                className="w-full px-4 py-2 border border-white/20 rounded-lg bg-white/10 text-white placeholder-text-secondary focus:ring-2 focus:ring-primary-500 focus:border-transparent backdrop-blur-sm"
              />
            </div>

            {/* Risk Level Filter */}
            <div>
              <label htmlFor="risk" className="block text-sm font-medium text-white mb-2">
                Risk Level
              </label>
              <select
                id="risk"
