...
const DashboardPage: React.FC = () => {
  ...
  // Get user's trading agents from Firebase
  const {
  ...
  // Mock subscribed agents (first 3 for demo) - COMMENTED OUT
  // const subscribedAgents = agents.slice(0, 3);
  const subscribedAgents = userTradingAgents.slice(0, 3); // Show first 3 user agents
      ...
      >
        ...
        <div className="relative max-w-7xl mx-auto px-6 py-12">
          ...
          >
              ...
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-gray-400">
                    Currently managing your portfolio
                  </p>
                </div>
              </div>
              ...
              userTradingAgents.length === 0 && (
                ...
                >
                  ...
                  <p className="text-gray-400 mb-4">
                    You haven't created any trading agents yet.
                  </p>
                  <motion.button
                    onClick={() => router.push("/marketplace")}
                    className="px-6 py-2 bg-primary-500/20 border border-primary-500/30 rounded-lg text-primary-300 hover:bg-primary-500/30 transition-colors"
                    whileHover={{ scale: 1.05 }}
                  >
                    Explore Marketplace
                  </motion.button>
            ...
            {/* Agents List */}
            {!agentsLoading && !agentsError && subscribedAgents.length > 0 && (
                      ...
                      <div className="relative z-10 flex flex-col lg:flex-row lg:items-center lg:justify-between">
                        <div className="flex-1 mb-6 lg:mb-0">
                          ...
                          <div className="flex flex-wrap gap-2">
                            <motion.span
                              ...
                              transition={{ duration: 0.2 }}
                            >
                              Agent ID: {agent.agent_id.slice(0, 8)}...
                            </motion.span>
                          </div>
                        </div>
                        ...
                        <div className="grid grid-cols-3 gap-8">
                          ...
                          >
                            ...
                            <div className="text-xs text-gray-400">Sub Fee</div>
                          </motion.div>
                          <motion.div
                            className="text-center"
                            whileHover={{ scale: 1.1 }}
