...
module.exports = {
  ...
  theme: {
    extend: {
      colors: {
        // Enhanced primary colors inspired by sky.money
        primary: {
          50: '#f0f9ff',
          100: '#e0f2fe',
          200: '#bae6fd',
        ...
        // Enhanced gradient colors inspired by reference sites
        gradient: {
          blue: '#00d4ff',
          purple: '#8b5cf6',
          pink: '#f472b6',
      ...
      backgroundImage: {
        ...
        'gradient-accent': 'linear-gradient(135deg, #22d3ee 0%, #00d4ff 100%)',
        'gradient-warm': 'linear-gradient(135deg, #fbbf24 0%, #f43f5e 100%)',
        'gradient-cool': 'linear-gradient(135deg, #10b981 0%, #22d3ee 100%)',
      ...
      fontFamily: {
        sans: ['JetBrains Mono', 'system-ui', 'monospace'],
        mono: ['JetBrains Mono', 'monospace'],
        web3: ['JetBrains Mono', 'monospace'],
      },
      fontSize: {
